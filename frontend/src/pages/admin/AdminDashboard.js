...
const styles = {
    boxStyled: {
        ...
        overflow: 'auto',
        padding: '20px',
        // Adjust card styling here to match TeacherDashboard
        '& .MuiCard-root': {
            marginBottom: '20px',
            borderRadius: '10px',
    ...
    appBarStyled: {
        backgroundColor: '#9ba5a8', // Adjust color to match teacher dashboard
    },
    toolBar: {
        pr: '24px',
    },
    ...
    drawerStyled: {
        ...
        '& .MuiDrawer-paper': {
            ...
            backgroundColor: '#a3c4ba', // Adjust color to match teacher dashboard
            color: '#050807',
        },
    },
    hideDrawer: {
